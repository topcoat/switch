...
describe('Topcoat switch', function() {
    'use strict';

    it('should output correct desktop dark css', function() {
        var actual = grunt.file.read('css/topcoat-switch-desktop-dark.css');
        var expected = grunt.file.read('test/expected/topcoat-switch-desktop-dark.css');
        assert.equal(actual, expected, 'should generate correct css');
    });

    it('should output correct desktop light css', function() {
        var actual = grunt.file.read('css/topcoat-switch-desktop-light.css');
        var expected = grunt.file.read('test/expected/topcoat-switch-desktop-light.css');
        assert.equal(actual, expected, 'should generate correct css');
    });

    it('should output correct mobile dark css', function() {
        var actual = grunt.file.read('css/topcoat-switch-mobile-dark.css');
        var expected = grunt.file.read('test/expected/topcoat-switch-mobile-dark.css');
        assert.equal(actual, expected, 'should generate correct css');
    });

    it('should output correct mobile light css', function() {
        var actual = grunt.file.read('css/topcoat-switch-mobile-light.css');
        var expected = grunt.file.read('test/expected/topcoat-switch-mobile-light.css');
        assert.equal(actual, expected, 'should generate correct css');
    });
